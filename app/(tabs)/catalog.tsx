  ...
  const loadData = useCallback(async () => {
    try {
      ...
      if (selectedCategory === 'packs') {
        ...
        // Add search filter for packs
        if (searchQuery.trim()) {
          query.ilike('name', `%${searchQuery.trim()}%`);
        }

        query.order(selectedSort.value, {
          ascending: selectedSort.order === 'asc'
        });

        const { data: packsData, error: packsError } = await query;
  ...
  const PackCard = ({ pack }: { pack: any }) => {
    ...
    return (
      ...
      >
        ...
        <Image
          source={{
            uri: pack.image_url || 'https://images.unsplash.com/photo-1608686207856-001b95cf60ca?q=80&w=1000'
          }}
  ...
  const ProductCard = ({ product }: { product: any }) => {
    ...
    const getDefaultImage = () => {
      const categoryMap: Record<string, string> = {
        'Viandes': 'https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?q=80&w=1000',
        'Poissons': 'https://images.unsplash.com/photo-1615141982883-c7ad0e69fd62?q=80&w=1000',
        'Snacks': 'https://images.unsplash.com/photo-1621939514649-280e2ee25f60?q=80&w=1000',
        'Légumes': 'https://images.unsplash.com/photo-1597362925123-77861d3fbac7?q=80&w=1000',
        'Boissons': 'https://images.unsplash.com/photo-1544145945-f90425340c7e?q=80&w=1000',
        'Alcools': 'https://images.unsplash.com/photo-1569529465841-dfecdab7503b?q=80&w=1000',
      };
      
      return categoryMap[product.categories?.name] || 'https://images.unsplash.com/photo-1542838132-92c53300491e?q=80&w=1000';
    };
    ...
    return (
      ...
      >
        ...
        <Image
          source={{
            uri: product.image_url || getDefaultImage()
          }}
          style={styles.productImage}
          resizeMode="cover"
        />
